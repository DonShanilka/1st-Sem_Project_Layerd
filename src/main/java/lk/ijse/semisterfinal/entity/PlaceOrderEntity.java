...
public class PlaceOrderEntity {
    ...
    public PlaceOrderEntity(String billId, JFXComboBox<String> itemId, Label itemName, Label itemPrice, LocalDate date, TextField qty, TextField discount, Label total, TextField payment, Label balance) {
        this.orderId = billId;
    ...
    public PlaceOrderEntity(String orderId, LocalDate date, String customerId, List<CartTm> cartTmList) {
